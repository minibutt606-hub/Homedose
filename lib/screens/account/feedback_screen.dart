...
class _FeedbackScreenState extends State<FeedbackScreen> {
  ...
  Future<void> _submitFeedback() async {
    ...
    if (subject.length > 255) {
      PremiumSnackbar.showError(title: 'Error', message: 'Subject must not exceed 255 characters');
      return;
    }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildLabel('Subject'),
            _buildTextField(hint: 'Enter Your Subject', controller: _subjectController),
            const SizedBox(height: 20),

            _buildLabel('Email'),
            _buildTextField(hint: 'Enter Your Email', controller: _emailController, keyboardType: TextInputType.emailAddress),
            const SizedBox(height: 20),

            _buildLabel('Message'),
            _buildTextField(hint: 'Enter Your Message', controller: _msgController, maxLines: 6),
